...
public record BookDTO(Long id, Long library_id, @NotNull String title, @NotNull String author,@NotNull BookGenre genre, @NotNull LocalDate publicationDate) implements Serializable
{
    @Override
